...
##### High Toxicity 1 Toxicity Scenario   (call it low toxicity before)
# A01.true<-c(-2.5)
# A02.true<-c(-2.5)
# A11.true<-c(1)
# A12.true<-c(0.2)
...
system.time({
  ...
  for (z in 1:nsims){
    ...
    while(i < ncohort){
      ...
      # cat(round(mean(a01),2),round(mean(a02),2),round(mean(log(a11)),2),round(mean(log(a12)),2),round(mean(e),2),"\n")
      ...
      for (t in 1:cohort){
        ...
        # if(all(prob.mtd==0)){
        #   cat("all doses are unsafe for this patient","\n")
        # }
        ...
        #End of do not skip restriction
        ...
        # End of Coherence Restriction
        
        # cat(m.new[t],"\n")
        # cat(prob.above,"\n")
        # if(all(prob.mtd==0)){
        #   cat("all unsafe for this patient","\n")
        # }
    ...
    if(stop==0){
      ...
      m.testing<-round(rnorm(testing.set,mean=mean.methadone,sd=sd.methadone),0)
      m.testing[which(m.testing<=min.methadone)]<-min.methadone
  ...
  # all.testing.best
  mean(all.testing.best[all.testing.best!=0])
  ...
  # accept.prior.belief<-mean(all.testing.accept[all.testing.accept!=0])
  # best.prior.belief<-mean(all.testing.accept[all.testing.accept!=0])
  # non.prior.belief<-mean(all.testing.non.tox)
  # dlts.prior.belief<-mean(all.dlts)/mean(all.ss)
  # ss.prior.belief<-mean(all.ss)
  # safety.prior.belief<-counter/nsims
  # futility.prior.belief<-counter.futility/nsims
  # all.m.prior.belief<-all.m
  # all.b.prior.belief<-all.b
  # all.s.prior.belief<-all.s
  
  
  # accept.low.1<-mean(all.testing.accept[all.testing.accept!=0])
  # best.low.1<-mean(all.testing.accept[all.testing.accept!=0])
  # non.low.1<-mean(all.testing.non.tox)
  # dlts.low.1<-mean(all.dlts)/mean(all.ss)
  # ss.low.1<-mean(all.ss)
  # safety.low.1<-counter/nsims
  # futility.low.1<-counter.futility/nsims
  # 
  # accept.low.2<-mean(all.testing.accept[all.testing.accept!=0])
  # best.low.2<-mean(all.testing.accept[all.testing.accept!=0])
  # non.low.2<-mean(all.testing.non.tox)
  # dlts.low.2<-mean(all.dlts)/mean(all.ss)
  # ss.low.2<-mean(all.ss)
  # safety.low.2<-counter/nsims
  # futility.low.2<-counter.futility/nsims
  # 
  # accept.med.1<-mean(all.testing.accept[all.testing.accept!=0])
  # best.med.1<-mean(all.testing.accept[all.testing.accept!=0])
  # non.med.1<-mean(all.testing.non.tox)
  # dlts.med.1<-mean(all.dlts)/mean(all.ss)
  # ss.med.1<-mean(all.ss)
  # safety.med.1<-counter/nsims
  # futility.med.1<-counter.futility/nsims
  # 
  # 
  # accept.med.2<-mean(all.testing.accept[all.testing.accept!=0])
  # best.med.2<-mean(all.testing.accept[all.testing.accept!=0])
  # non.med.2<-mean(all.testing.non.tox)
  # dlts.med.2<-mean(all.dlts)/mean(all.ss)
  # ss.med.2<-mean(all.ss)
  # safety.med.2<-counter/nsims
  # futility.med.2<-counter.futility/nsims
  # 
  # accept.high.1<-mean(all.testing.accept[all.testing.accept!=0])
  # best.high.1<-mean(all.testing.accept[all.testing.accept!=0])
  # non.high.1<-mean(all.testing.non.tox)
  # dlts.high.1<-mean(all.dlts)/mean(all.ss)
  # ss.high.1<-mean(all.ss)
  # safety.high.1<-counter/nsims
  # futility.high.1<-counter.futility/nsims
  # 
  # 
  # accept.high.2<-mean(all.testing.accept[all.testing.accept!=0])
  # best.high.2<-mean(all.testing.accept[all.testing.accept!=0])
  # non.high.2<-mean(all.testing.non.tox)
  # dlts.high.2<-mean(all.dlts)/mean(all.ss)
  # ss.high.2<-mean(all.ss)
  # safety.high.2<-counter/nsims
  # futility.high.2<-counter.futility/nsims
  # 
  accept.unsafe<-mean(all.testing.accept[all.testing.accept!=0])
  best.unsafe<-mean(all.testing.accept[all.testing.accept!=0])
  non.unsafe<-mean(all.testing.non.tox)
  dlts.unsafe<-mean(all.dlts)/mean(all.ss)
  ss.unsafe<-mean(all.ss)
  safety.unsafe<-counter/nsims
  futility.unsafe<-counter.futility/nsims
})